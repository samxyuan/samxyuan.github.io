		...
		createControl: function ( btn, e )
		{
			...
			{	
				...
				{					
					...
					a.addWithPopup( c, "Blog Desc", "blog_desc" );
					a.addWithPopup( c, "Blog Slide", "blog_slide" );
					...
					a.addWithPopup( c, "Ajax Portfolio", "ajax_portfolio" );
					a.addWithPopup( c, "Portfolio", "portfolio" );
					a.addWithPopup( c, "Portfolio Desc", "portfolio_desc" );
