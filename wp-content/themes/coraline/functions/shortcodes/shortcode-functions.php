...
function shortcode_map($atts, $content = null)
{
	...
	if($address) {
		$output = '<div class="map-canvas" data-lat="'.$lat.'" data-lng="'.$lng.'" data-address="'.$address.'" data-zoom="'.$zoom.'" data-mapTitle="Google, Inc" style="width: '.$width.'px; height: '.$height.'px;"></div>'."\n";
	}
