...
function prod_edit_columns_slideshow($columns)
{
	...
	$columns['slideshow_name'] = __('Name', 'TR');
	$columns['slideshow_shortcode'] = __('Shortcode', 'TR');
	$columns['slideshow_desc'] = __('Description', 'TR');
...
function prod_custom_columns_slideshow($column)
{
	...
	$name = get_meta_option('slideshow_name');
	$shortcode = '[slideshow id="'.$post->ID.'"]';
	$desc = get_meta_option('slideshow_desc');
