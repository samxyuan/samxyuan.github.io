...
define('THEME_NAME', 'Coraline');
define('THEME_SLUG', 'coraline');
define('THEME_FOLDER_NAME', 'coraline');
...
require_once(MODULES_DIR.'/ajax-portfolio.php');
require_once(MODULES_DIR.'/blog-desc.php');
require_once(MODULES_DIR.'/blog-slide.php');
require_once(MODULES_DIR.'/portfolio.php');
require_once(MODULES_DIR.'/portfolio-desc.php');
...
require_once(PHP_DIR.'/format-standard.php');
require_once(PHP_DIR.'/format-video.php');
require_once(PHP_DIR.'/front-page.php');
